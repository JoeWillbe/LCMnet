%% 
function [deltaB,output_chi] = getDataAugV2(chi_mo,maskErode,Params,n_time,filter_flag)
% [deltaB,output_chi] = getDataAugV2(chi_mo,maskErode,Params,n_time,th,filter_flag)
% Author: Joe
% Affiliation: XMU
% Create: 2022-12
% Updated Joe: 2023-11
