%% 
function [deltaB,output_chi] = getDataAugumentV2(chi_mo,maskErode,Params,n_time,filter_flag)
% [deltaB,output_chi] = getDataAugumentV2(chi_mo,maskErode,Params,n_time,th,filter_flag)
% Author: Joe
% Affiliation: XMU
% Create: 2022-12
% Updated Joe: 2023-11
...
chi_temp = chi_mo; 
% chi_temp = 1.1*chi_temp; % preprocessing with mild linear amplification
...
% get deltab    
datatype='single';     
[D_k_temp,~] = getDk(Params, Params.TAng, datatype,1,0,3,0.1); 
